...
class GeneticAlgorithm {
    ...
    private static final int NUMB_OF_ELITE_CHROMOSOMES=1;
    ...
    private Population mutatePopulation(Population population){
        Population mutatePopulation=   keepEliteChromosomes(population);
    ...
    private Population selectTournamentPopulation(Population population){
        ...
        for (int x = 0; x < TOURNAMENT_SELECTION_SIZE; x++) {
            tournamentPopulation.getChromosomes()[x]=population.getChromosomes()
